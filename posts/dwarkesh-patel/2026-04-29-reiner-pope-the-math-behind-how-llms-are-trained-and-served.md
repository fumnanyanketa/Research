...
[](https://substackcdn.com/image/fetch/$s_!rYuq!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa50660bc-66f9-4b8f-a9ac-30976e26f8e8_2048x1754.png)
...
I think often the number of active parameters could be in the range of a hundred billion, something like that. Maybe a bit larger. So multiply by 20 to get the Chinchilla token count. So Chinchilla, _D Chinchilla_, would be around two trillion. We see we're about a hundred times larger than that.

**Dwarkesh Patel**

What does _D Chinchilla_ actually mean?
